	...
	function initData() {
		...
		data = {
				...
				},
			{
				...
				id: 132,
				template: "templateLeftColumn",
				keyName: "privateEconomySE",
				keyArea: "Solutions",
				tags: "sv,corporate,large,medium,small",
				backgroundImage: "",
				hideNotes: false,
				locked: false,
				localName: localize("privateEconomySELocalName"),
				localArea: localize("coSolutionsLocalArea"),
				title: localize("privateEconomySETitle"),
				nestedLists: [
				    {text: localize("privateEconomySEBullet1")},
				    {text: localize("privateEconomySEBullet2")},
				    {text: localize("privateEconomySEBullet3")},
				    {text: localize("privateEconomySEBullet4")},
				    {text: localize("privateEconomySEBullet5")}
                ],
				image: "privateeconomy.jpg"
			},			
			//status
			{
				id: 132,
			...
			},
			{
				...
				keyName: "PB2 SE",
				keyArea: "Solutions",
				tags: "none,corporate,aboutNordea,medium,small,large",
				backgroundImage: "",
				hideNotes: false,
				locked: false,
			...
			
			{
				...
				keyName: "Import Risk",
				keyArea: "Solutions",
				tags: "none,corporate,markets,medium,small,large",
				backgroundImage: "",
				backgroundType: BACKGROUND_TYPE_RIGHT,
				hideNotes: false,
				locked: false,
			...
			},
			{
				...
				keyArea: "Solutions",
				tags: "none,360,corporate,markets,medium,small,large",
				backgroundImage: "",
				hideNotes: false,
				locked: false,
