...
var Reveal = (function(){
	...
	var SLIDES_SELECTOR = '.reveal .slides section',
		...
		// Detects support for CSS 2D transitions
		supportsCSSTransition = 'WebkitTransition' in document.body.style ||
	...
	function updateSlides( selector, index ) {
		...
		if( slidesLength ) {
			...
			for( var i = 0; i < slidesLength; i++ ) {
				...
				if (!supportsCSSTransition && config.transition != 'none')
				{
					/*
					**********************************************
					SPECIAL HACK TO ENABLE NON CSS TRANSITION IN IE9
					**********************************************
					*/
					if (i < index)
					{
